...
public class EmployeeDAOImpl implements EmployeeDAO{
	...
	@Override
	public int createEmployee(Emp emp) throws SQLException {
		try {
...
("update employee set ename=?, epass=?,esal=?,ecity=?,flag=? where eid=?");			
	...
	@Override
	public int deleteEmployeeByID(int eno) throws SQLException {
		try {
	...
	@Override
	public int deleteEmployeeByName(String ename) throws SQLException {
		try {
